...
<?php render_navbar(); ?>
    ...
    <section class="intro-section">
        <div class="intro-section__content">
            ...
            <p class="intro-section__text">At Rose Brokers, your privacy is our priority. We are committed to protecting your personal information and 
            ...
            <div class = "Dropdown_Section_Information">
              <p class="intro-section__text">The information we might collect and hold about you includes:
